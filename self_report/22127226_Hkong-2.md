...
>Tự xây dựng backend cùng với việc làm frontend, để có thể hiểu rõ hơn về luồng, về api,... cũng như có thể chủ động hơn trong việc thực hiện các yêu cầu của đề tài.
---
