-- Add avatarUrl and defaultArticleImageUrl columns to Brand table
ALTER TABLE "Brand"
  ADD COLUMN IF NOT EXISTS "avatarUrl" TEXT,
  ADD COLUMN IF NOT EXISTS "defaultArticleImageUrl" TEXT;

-- Migrate existing logoUrl data to both new fields
UPDATE "Brand"
SET 
  "avatarUrl" = "logoUrl",
  "defaultArticleImageUrl" = "logoUrl"
...
-- Recreate update_brand function with new parameters
CREATE OR REPLACE FUNCTION update_brand(
    ...
    _avatar_url TEXT DEFAULT '___NO_UPDATE___',
...
BEGIN
    ...
    SET
        ...
        "avatarUrl" = CASE WHEN _avatar_url = '___NO_UPDATE___' THEN "avatarUrl" ELSE _avatar_url END,
        "defaultArticleImageUrl" = CASE WHEN _default_article_image_url = '___NO_UPDATE___' THEN "defaultArticleImageUrl" ELSE _default_article_image_url END
    WHERE id = _id
    ...
    RETURN json_build_object(
        ...
        'avatarUrl', updatedBrand."avatarUrl",
