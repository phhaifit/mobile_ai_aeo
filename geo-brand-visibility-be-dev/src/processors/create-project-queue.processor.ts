...
@Processor(QueueNames.CreateProject)
export class CreateProjectQueueProcessor extends BaseQueueProcessor {
  protected readonly logger = new Logger(CreateProjectQueueProcessor.name);
