-- Remove avatarUrl column and related functions

ALTER TABLE "Brand"
  DROP COLUMN IF EXISTS "avatarUrl";

DROP FUNCTION IF EXISTS update_brand_avatar(UUID, TEXT);
...
DROP FUNCTION IF EXISTS update_brand_default_article_image(UUID, TEXT);
