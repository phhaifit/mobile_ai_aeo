-- Add cloudflareHostnameId column to Brand table for tracking Cloudflare custom hostname
ALTER TABLE "Brand" 
  ADD COLUMN IF NOT EXISTS "cloudflareHostnameId" TEXT;

-- Index for lookups by cloudflareHostnameId
CREATE INDEX IF NOT EXISTS "Brand_cloudflareHostnameId_idx" 
  ON "Brand" ("cloudflareHostnameId") 
  WHERE "cloudflareHostnameId" IS NOT NULL;
...
-- Recreate update_brand function with cloudflare_hostname_id parameter
